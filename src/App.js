...
import SochiRoute1 from "./pdf/sochi1.pdf"
import SochiRoute2 from "./pdf/sochi1.pdf"
import SochiRoute3 from "./pdf/sochi1.pdf"
import SpbRoute1 from "./pdf/sochi1.pdf"
import SpbRoute2 from "./pdf/sochi1.pdf"
import SpbRoute3 from "./pdf/sochi1.pdf"
...
const questions = {
    sochi: [{
        ...
        answers: [
            { img: SochiM0I1Image, text: `Гулять в природных заповедниках`, routeIndex: 0 },
            { img: SochiM1I1Image, text: `Наслаждаться видами на горы`, routeIndex: 1 },
            { img: SochiM2I1Image, text: `Пробовать продукты с местных ферм`, routeIndex: 2 },
        ]
    }],
    spb: [{
        question: `Как ты любишь отдыхать?`,
        answers: [
            { img: SpbM0I1Image, text: `Гулять у реки и наслаждаться видами`, routeIndex: 0 },
            { img: SpbM2I1Image, text: `За городом на дачах`, routeIndex: 1 },
            { img: SpbM2I1Image, text: `Знакомиться с культурой разных народов`, routeIndex: 2 },
        ]
    }]
}
                                ...
                                <div className="relative">
                                    <div className={`bg-cover xl:h-screen xl:flex xl:flex-col xl:justify-between xl:items-center`} style={{ backgroundImage: `url('${Clouds}')` }}>
                                        <div className={`xl:grow container mx-auto  flex flex-col items-center justify-start relative xl:py-6`}>
                                            ...
                                            <img src={ImagesGroup} alt={``} className={`shrink-0 w-[16rem] sm:w-[346px] xs:w-auto mb-4 xl:mb-10`} />
                                        ...
                                        <div className={`xl:w-full z-10 relative shrink-0 overflow-hidden xl:-mt-24 pt-12 xl:pt-24 pointer-events-none max-w-lg xl:max-w-[1920px] mx-auto flex flex-col items-center`}>
                                            ...
                                            <div className={`w-full xl:w-[1920px] h-[26.5rem] relative -top-8 -mt-36`}>
                                                ...
                                                <div className={`hidden xl:block absolute w-[29.5%] xl:w-[17.5%] left-[39.43%] xl:left-[49.43%] rotate-[-10.91deg] xl:rotate-[3.5deg] top-[48.88%] xl:top-[58.88%]`}>
                                                    <img src={Photo7} alt={``} className="w-full" style={scale} />
                                                </div>
                                                ...
                                                <div className={`absolute w-[27.53%] xl:w-[13.53%] left-[61.1%] xl:left-[76.1%] rotate-[5deg] top-[48%] xl:top-[12%]`}>
                                                    <img src={Photo1} alt={``} className="w-full" style={scale} />
                                                </div>
                                                <div className={`hidden xl:block absolute w-[15.71%] left-[63.7%] rotate-[-11.774deg] top-[41.12%]`}>
                                                    <img src={Photo6} alt={``} className="w-full" style={scale} />
                                                </div>
                                        ...
                                        <div className={`bg-gradient-to-t from-indigo-300 to-blue-100 xl:mb-20 px-4 xl:px-8 relative z-20 mt-32 xl:mt-24`}>
                                            ...
                                            <div className="max-w-lg xl:container mx-auto relative">
                                                <div className="absolute top-0 left-0 bottom-0 right-0 pointer-events-none">
                                                    <img src={Roadm1} className="absolute max-w-none -top-[8.05rem] -right-[43.7rem] xl:hidden" />
                                                    <img src={Roadm2} className="absolute max-w-none -bottom-[0.6rem] -left-[25.5rem] xl:hidden" />
                                                    <img src={Roadm3} className="absolute max-w-none -bottom-[87rem] -left-[2.8rem] xl:hidden" />
                                                </div>
                                                <div className="bg-yellow-200 rounded-[26px] flex flex-col xl:flex-row px-8 xl:px-16 xl:px-24 pt-6 pb-10 xl:py-16 relative justify-between -mt-32 xl:-mt-24">
                                                    <img src={LR1} className="absolute max-w-none pointer-events-nones top-[1.52rem] -right-[10.75rem] xl:hidden" />
                                                    <img src={LL1} className="absolute max-w-none pointer-events-nones -bottom-[0rem] -left-[2.375rem] xl:hidden" />
                                        ...
                                        <div className="relative mb-24 max-w-lg xl:max-w-[1920px] min-h-screen mx-auto px-4 xl:px-8 z-10">
                                            <div className="absolute top-0 left-0 right-0 bottom-0 items-center justify-center pointer-events-none hidden xl:flex">
                                                <svg width="1533" height="1828" className="max-w-none absolute -mt-16 -ml-[2rem]" viewBox="0 0 1533 1828" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1516.12 1622.41C1057.32 1231 1596.23 605.546 1205.4 566.191C841.611 529.56 523.049 1230.68 276.421 1034.86C12.5435 825.334 547.023 669.913 17.3608 204.818" stroke="#F4FF70" stroke-width="33.3128" stroke-miterlimit="11.4737" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M1516.12 1622.41C1057.32 1231 1596.23 605.546 1205.4 566.191C841.611 529.56 523.049 1230.68 276.421 1034.86C12.5435 825.334 547.023 669.913 17.3608 204.818" stroke="black" stroke-width="1.99877" stroke-miterlimit="11.4737" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="13.33 13.33" />
                                                </svg>
                                            </div>
                                        ...
                                        <div className="relative mb-16 xl:mb-20 flex flex-col items-center justify-center max-w-lg mx-auto xl:max-w-none">
                                            ...
                                            <div className={`relative rotate-[3deg] w-[48rem] -scale-x-100 mb-20 `}>
                                                <div className="scale-[.85] sm:scale-[1]">
                                                    <img src={Girls} alt={``} className="w-full" style={scale2} />
                                                </div>
                                            </div>
                                            <button onClick={e => {
                                                smooth.current.scrollIntoView(citiesRef.current, { offsetTop: 32 });
