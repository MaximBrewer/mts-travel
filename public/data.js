window.questions = {
    sochi: [{
        ...
        answers: [
            { img: `/routes/sochi/m0/image.jpg?v=1.0"`, text: `Гулять в природных заповедниках`, routeIndex: 0 },
            { img: `/routes/sochi/m1/image.jpg?v=1.0"`, text: `Наслаждаться видами на горы`, routeIndex: 1 },
            { img: `/routes/sochi/m2/image.jpg?v=1.0"`, text: `Пробовать продукты с местных ферм`, routeIndex: 2 },
        ]
    }],
    spb: [{
        question: `Как ты любишь отдыхать?`,
        answers: [
            { img: `/routes/spb/m0/image.jpg?v=1.0"`, text: `Гулять у реки и наслаждаться видами`, routeIndex: 0 },
            { img: `/routes/spb/m1/image.jpg?v=1.0"`, text: `За городом на дачах`, routeIndex: 1 },
            { img: `/routes/spb/m2/image.jpg?v=1.0"`, text: `Знакомиться с культурой разных народов`, routeIndex: 2 },
        ]
    }],
    kalinin: [{
        question: `Как ты любишь отдыхать?`,
        answers: [
            { img: `/routes/kalinin/m0/image.jpg?v=1.0"`, text: `Уехать туда, где поменьше людей`, routeIndex: 0 },
            { img: `/routes/kalinin/m1/image.jpg?v=1.0"`, text: `Уйти от суеты и замедлиться`, routeIndex: 1 },
            { img: `/routes/kalinin/m2/image.jpg?v=1.0"`, text: `Путешествовать во времени`, routeIndex: 2 },
        ]
    }],
    kazan: [{
        question: `Как ты любишь отдыхать?`,
        answers: [
            { img: `/routes/kazan/m0/image.jpg?v=1.0"`, text: `Погружаться в местный колорит`, routeIndex: 0 },
            { img: `/routes/kazan/m1/image.jpg?v=1.0"`, text: `Находить диковинные места рядом`, routeIndex: 1 },
            { img: `/routes/kazan/m2/image.jpg?v=1.0"`, text: `Прикасаться к истории`, routeIndex: 2 },
        ]
    }]
}
    ...
    sochi: [
        {
            ...
            link: "/pdf/Sochi_travel giude_zapovedniki.pdf?v=1.0",
            items: [
                {
                    title: `Отель`,
                    ...
                    icon: `/routes/sochi/m2/i0/icon.svg?v=1.0"`,
                    image: `/routes/sochi/m2/i0/image.jpg?v=1.0"`
                },
                {
                    ...
                    icon: `/routes/sochi/m2/i1/icon.svg?v=1.0"`,
                    image: `/routes/sochi/m2/i1/image.jpg?v=1.0"`
                },
                {
                    title: `Белый каньон`,
                    ...
                    icon: `/routes/sochi/m2/i2/icon.svg?v=1.0"`,
                    image: `/routes/sochi/m2/i2/image.jpg?v=1.0"`
                }
            ]
        },
        {
            ...
            link: "/pdf/Sochi_travel giude_v gory.pdf?v=1.0",
            items: [
                {
                    title: `Отель`,
                    text: `Мы сделали подборку отелей в Адлере, где можно комфортно переночевать и начать путешествие на каршеринге.`,
                    icon: `/routes/sochi/m1/i0/icon.svg?v=1.0"`,
                    image: `/routes/sochi/m1/i0/image.jpg?v=1.0"`
                },
                {
                    ...
                    icon: `/routes/sochi/m1/i1/icon.svg?v=1.0"`,
                    image: `/routes/sochi/m1/i1/image.jpg?v=1.0"`
                },
                {
                    title: `Водопад`,
                    ...
                    icon: `/routes/sochi/m1/i2/icon.svg?v=1.0"`,
                    image: `/routes/sochi/m1/i2/image.jpg?v=1.0"`
                }
            ]
        },
        {
            ...
            link: "/pdf/Sochi_travel giude _agritourism.pdf?v=1.0",
            items: [
                {
                    title: `Отель`,
                    text: `Начните свое путешествие комфортно: мы подобрали несколько отелей, из которых удобно будет начать наш маршрут.`,
                    icon: `/routes/sochi/m0/i0/icon.svg?v=1.0"`,
                    image: `/routes/sochi/m0/i0/image.jpg?v=1.0"`
                },
                {
                    ...
                    icon: `/routes/sochi/m0/i1/icon.svg?v=1.0"`,
                    image: `/routes/sochi/m0/i1/image.jpg?v=1.0"`
                },
                {
                    title: `Обед на ферме`,
                    ...
                    icon: `/routes/sochi/m0/i2/icon.svg?v=1.0"`,
                    image: `/routes/sochi/m0/i2/image.jpg?v=1.0"`
                }
            ]
    ...
    spb: [
        {
            ...
            link: "/pdf/SP_travel giude_Neva.pdf?v=1.0",
            items: [
                {
                    title: `Отель`,
                    ...
                    icon: `/routes/spb/m0/i0/icon.svg?v=1.0"`,
                    image: `/routes/spb/m0/i0/image.jpg?v=1.0"`
                },
                {
                    ...
                    icon: `/routes/spb/m0/i1/icon.svg?v=1.0"`,
                    image: `/routes/spb/m0/i1/image.jpg?v=1.0"`
                },
                {
                    ...
                    icon: `/routes/spb/m0/i2/icon.svg?v=1.0"`,
                    image: `/routes/spb/m0/i2/image.jpg?v=1.0"`
                }
            ]
        },
        {
            ...
            link: "/pdf/SP_travel giude_dacha.pdf?v=1.0",
            items: [
                {
                    title: `Отель`,
                    text: `Мы подготовили отели, расположенные близко к выезду в сторону Гатчины, чтобы путешествие началось без пробок.`,
                    icon: `/routes/spb/m1/i0/icon.svg?v=1.0"`,
                    image: `/routes/spb/m1/i0/image.jpg?v=1.0"`
                },
                {
                    ...
                    icon: `/routes/spb/m1/i1/icon.svg?v=1.0"`,
                    image: `/routes/spb/m1/i1/image.jpg?v=1.0"`
                },
                {
                    ...
                    icon: `/routes/spb/m1/i2/icon.svg?v=1.0"`,
                    image: `/routes/spb/m1/i2/image.jpg?v=1.0"`
                }
            ]
        },
        {
            ...
            link: "/pdf/SP_travel giude_Karelia.pdf?v=1.0",
            items: [
                {
                    title: `Отель`,
                    ...
                    icon: `/routes/spb/m2/i0/icon.svg?v=1.0"`,
                    image: `/routes/spb/m2/i0/image.jpg?v=1.0"`
                },
                {
                    ...
                    icon: `/routes/spb/m2/i1/icon.svg?v=1.0"`,
                    image: `/routes/spb/m2/i1/image.jpg?v=1.0"`
                },
                {
                    ...
                    icon: `/routes/spb/m2/i2/icon.svg?v=1.0"`,
                    image: `/routes/spb/m2/i2/image.jpg?v=1.0"`
                }
            ]
        }
    ],
    kalinin: [
        {
            ...
            link: "/pdf/Kaliningrad_travel giude_секретные места.pdf?v=1.0",
            items: [
                {
                    title: `Отель`,
                    text: `Уютные отели в самом сердце города — комфортно ночевать и начинать маршрут.`,
                    icon: `/routes/kalinin/m0/i0/icon.svg?v=1.0"`,
                    image: `/routes/kalinin/m0/i0/image.jpg?v=1.0"`
                },
                {
                    title: `Куршская коса`,
                    text: `Нашли места на косе, о которых знают не все туристы и даже местные. Отличные локации для уединения.`,
                    icon: `/routes/kalinin/m0/i1/icon.svg?v=1.0"`,
                    image: `/routes/kalinin/m0/i1/image.jpg?v=1.0"`
                },
                {
                    ...
                    icon: `/routes/kalinin/m0/i2/icon.svg?v=1.0"`,
                    image: `/routes/kalinin/m0/i2/image.jpg?v=1.0"`
                }
            ]
        },
        {
            ...
            link: "/pdf/Kaliningrad_travel giude_время замедлиться.pdf?v=1.0",
            items: [
                {
                    title: `Отель`,
                    text: `Нашли отели, чтобы красивые виды были не только из окна каршеринга, но и из спальни.`,
                    icon: `/routes/kalinin/m1/i0/icon.svg?v=1.0"`,
                    image: `/routes/kalinin/m1/i0/image.jpg?v=1.0"`
                },
                {
                    title: `Экоферма`,
                    ...
                    icon: `/routes/kalinin/m1/i1/icon.svg?v=1.0"`,
                    image: `/routes/kalinin/m1/i1/image.jpg?v=1.0"`
                },
                {
                    title: `Светлогорск`,
                    ...
                    icon: `/routes/kalinin/m1/i2/icon.svg?v=1.0"`,
                    image: `/routes/kalinin/m1/i2/image.jpg?v=1.0"`
                }
            ]
        },
        {
            ...
            link: "/pdf/Kaliningrad_travel giude_свидание с Пруссией.pdf?v=1.0",
            items: [
                {
                    title: `Отель`,
                    ...
                    icon: `/routes/kalinin/m2/i0/icon.svg?v=1.0"`,
                    image: `/routes/kalinin/m2/i0/image.jpg?v=1.0"`
                },
                {
                    title: `Порт`,
                    text: `Начните день в городском порту: корабли, соленый запах моря и аромат местного кофе — что еще нужно для идеального утра?`,
                    icon: `/routes/kalinin/m2/i1/icon.svg?v=1.0"`,
                    image: `/routes/kalinin/m2/i1/image.jpg?v=1.0"`
                },
                {
                    ...
                    icon: `/routes/kalinin/m2/i2/icon.svg?v=1.0"`,
                    image: `/routes/kalinin/m2/i2/image.jpg?v=1.0"`
                }
            ]
        }
    ],
    kazan: [
        {
            ...
            link: "/pdf/Kazan_travel giude_сердце Казани.pdf?v=1.0",
            items: [
                {
                    title: `Отель`,
                    ...
                    icon: `/routes/kazan/m0/i0/icon.svg?v=1.0"`,
                    image: `/routes/kazan/m0/i0/image.jpg?v=1.0"`
                },
                {
                    title: `Туган Авылым`,
                    ...
                    icon: `/routes/kazan/m0/i1/icon.svg?v=1.0"`,
                    image: `/routes/kazan/m0/i1/image.jpg?v=1.0"`
                },
                {
                    title: `Кул Шариф`,
                    ...
                    icon: `/routes/kazan/m0/i2/icon.svg?v=1.0"`,
                    image: `/routes/kazan/m0/i2/image.jpg?v=1.0"`
                }
            ]
        },
        {
            ...
            link: "/pdf/Kazan_travel giude_природа окрестностей.pdf?v=1.0",
            items: [
                {
                    title: `Отель`,
                    ...
                    icon: `/routes/kazan/m1/i0/icon.svg?v=1.0"`,
                    image: `/routes/kazan/m1/i0/image.jpg?v=1.0"`
                },
                {
                    ...
                    icon: `/routes/kazan/m1/i1/icon.svg?v=1.0"`,
                    image: `/routes/kazan/m1/i1/image.jpg?v=1.0"`
                },
                {
                    title: `Каньоны`,
                    ...
                    icon: `/routes/kazan/m1/i2/icon.svg?v=1.0"`,
                    image: `/routes/kazan/m1/i2/image.jpg?v=1.0"`
                }
            ]
        },
        {
            ...
            link: "/pdf/Kazan_travel giude_древние города.pdf?v=1.0",
            items: [
                {
                    title: `Отель`,
                    ...
                    icon: `/routes/kazan/m2/i0/icon.svg?v=1.0"`,
                    image: `/routes/kazan/m2/i0/image.jpg?v=1.0"`
                },
                {
                    title: `Город-остров`,
                    ...
                    icon: `/routes/kazan/m2/i1/icon.svg?v=1.0"`,
                    image: `/routes/kazan/m2/i1/image.jpg?v=1.0"`
                },
                {
                    ...
                    icon: `/routes/kazan/m2/i2/icon.svg?v=1.0"`,
                    image: `/routes/kazan/m2/i2/image.jpg?v=1.0"`
                }
            ]
        }
    ]
